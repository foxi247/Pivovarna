          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="rounded"
              />
              <label htmlFor="catActive" className="text-admin-text text-sm">Активна</label>
            </div>
          </div>
            ...
            <tbody className="divide-y divide-admin-border">
              {categories.map((cat) => (
                <tr key={cat.id} className="hover:bg-stone-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-admin-text-muted">{cat._count?.articles ?? 0}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2 justify-end">
                      ...
                      <button
                        ...
                        title={(cat._count?.articles ?? 0) > 0 ? 'Нельзя удалить: есть статьи' : 'Удалить'}
                      >
                        <Trash2 size={14} />
                      </button>
                    </div>
